...
This way I can now use the check-ups 1, 2, 3  of each patient and I can also use the patients I couldn't use before because I don't need that fourth check-up . With this approach I have twice as much training rows, **12000**~.
...
Our base model, Gradient Boosting, already uses this idea by having an ensamble of trees internally.
