...
This implies that I can now use the check-ups 1, 2, 3 and 2, 3, 4  of each patient and make two different rows. With this approach I have twice as much training rows, **12000**~.
